...
export const insertCommentsSchema = createInsertSchema(comments, {
  ...
  description: z.string().min(14, "La descripción es requerida").max(500, "La descripción es muy larga"),
  direction: z.enum(['left', 'bottom'], { message: "La dirección debe ser 'left' o 'bottom'" }),
